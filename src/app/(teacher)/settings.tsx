...
import { User, Mail, CreditCard, LogOut, Info, Award } from 'lucide-react-native';
...
export default function TeacherSettings() {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: Colors.dark.background }}>
      <GlobalHeader role="teacher" title="Settings" />
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.nameText}>{profile?.full_name ?? 'Instructor Profile'}</Text>
        <Text style={styles.roleBadge}>Instructor Portal</Text>
      </View>
      ...
      <View style={styles.card}>
        ...
        {profile?.department && (
          <View style={[styles.infoRow, styles.borderTop]}>
            <Award size={16} color={Colors.dark.textSecondary} style={styles.icon} />
            <View style={styles.infoBody}>
